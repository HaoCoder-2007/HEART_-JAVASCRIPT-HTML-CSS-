...
const vTracks = [
    ...
    { name: "Đợi - 52Hz, RIO", src: "music/VIE/Doi.mp3" },
    ...
    { name: "Giayphut - Kidsai, Niz", src: "music/VIE/Giayphut.mp3" },
    ...
    { name: "Một bài hát không vui mấy - T.R.I, Dangrangto, Donal", src: "music/VIE/Motbaihatkhongvuimay.mp3" },
    ...
    { name: "Quên đặt tên - Phạm Nguyên Ngọc", src: "music/VIE/Quendatten.mp3" },
    ...
    { name: "Tập đi - Truant Fu", src: "music/VIE/Tapdi.mp3" },
...
const usukTracks = [
    ...
    { name: "Best part - Daniel Caesar, H.E.R.", src: "music/US_UK/Bestpart.mp3" },
    ...
    { name: "I do - 911", src: "music/US_UK/Ido.mp3" },
    ...
    { name: "Kill bill - SZA", src: "music/US_UK/Killbill.mp3" },
    ...
    { name: "Telepatía - Kali Uchis", src: "music/US_UK/Telepatia.mp3" },
    ...
    { name: "Without me - Halsey", src: "music/US_UK/Withoutme.mp3" },
...
const atshTracks = [
    ...
    { name: "Hơn là bạn - Ngô Kiến Huy, Vũ Cát Tường, Karik, GDucky, Sơn.K, Vương Bình, MIN", src: "music/VIE/ATSH/Honlaban.mp3" },
    { name: "Người như anh xứng đáng cô đơn - Vũ Cát Tường, Ngô Kiến Huy, Negav, Jey B, Karik, GDucky", src: "music/VIE/ATSH/Nguoinhuanhxungdangcodon.mp3" },
